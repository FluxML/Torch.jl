...
function at_from_blob(data, sizes, nsizes, _strides, _nstrides, dev) where T
  ccall((:at_from_blob, :libdoeye_caml), tensor, (tensor, Ptr{Int64}, Cint, Ptr{Int64}, Cint, Cint), data, sizes, nsizes, _strides, _nstrides, dev)
end
