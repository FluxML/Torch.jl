...
function at_from_blob(ptr, data, sizes, nsizes, _strides, _nstrides, dev) where T
  @runtime_error_check ccall((:at_from_blob, :libdoeye_caml), Cint, (Ptr{Cvoid}, tensor, Ptr{Int64}, Cint, Ptr{Int64}, Cint, Cint), ptr, data, sizes, nsizes, _strides, _nstrides, dev)
end
...
function at_tensor_of_data(ptr, vs, dims, ndims, element_size_in_bytes, type_t)
    @runtime_error_check ccall((:at_tensor_of_data, :libdoeye_caml), Cint, (Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Int64}, Cint, Cint, Cint), ptr, vs, dims, ndims, element_size_in_bytes, type_t)
end

function at_copy_data(tensor_t, vs, numel, element_size_in_bytes)
    @runtime_error_check ccall((:at_copy_data, :libdoeye_caml), Cint, (tensor, Ptr{Cvoid}, Int64, Cint), tensor_t, vs, numel, element_size_in_bytes)
end

function at_float_vec(op, values, value_len, type_t)
    @runtime_error_check ccall((:at_float_vec, :libdoeye_caml), Cint, (tensor, Ptr{Cdouble}, Cint, Cint), op, values, value_len, type_t)
end

function at_int_vec(op, values, value_len, type_t)
    @runtime_error_check ccall((:at_int_vec, :libdoeye_caml), Cint, (tensor, Ptr{Int64}, Cint, Cint), op, values, value_len, type_t)
end

function at_defined(op, arg1)
    @runtime_error_check ccall((:at_defined, :libdoeye_caml), Cint, (Ptr{Cint}, tensor,), op, arg1)
end

function at_dim(i, arg1)
    @runtime_error_check ccall((:at_dim, :libdoeye_caml), Cint, (Ptr{Cint}, tensor,),  i, arg1)
end
...
function at_scalar_type(op, arg1)
    @runtime_error_check ccall((:at_scalar_type, :libdoeye_caml), Cint, (Ptr{Cint}, tensor,), op, arg1)
end
...
function at_requires_grad(op, arg1)
    @runtime_error_check ccall((:at_requires_grad, :libdoeye_caml), Cint, (Ptr{Cint}, tensor,), op, arg1)
end
...
function at_get(op, arg1, index)
    @runtime_error_check ccall((:at_get, :libdoeye_caml), Cint, (Ptr{Cvoid}, tensor, Cint), op, arg1, index)
end
...
function at_double_value_at_indexes(op, arg1, indexes, indexes_len)
    @runtime_error_check ccall((:at_double_value_at_indexes, :libdoeye_caml), Cint, (Ptr{Cdouble}, tensor, Ptr{Cint}, Cint), op, arg1, indexes, indexes_len)
end

function at_int64_value_at_indexes(op, arg1, indexes, indexes_len)
    @runtime_error_check ccall((:at_int64_value_at_indexes, :libdoeye_caml), Cint, (Ptr{Int64}, tensor, Ptr{Cint}, Cint), op, arg1, indexes, indexes_len)
end
...
function at_save(arg1, filename)
    @runtime_error_check ccall((:at_save, :libdoeye_caml), Cint, (tensor, Cstring), arg1, filename)
end

function at_load(filename, op)
    @runtime_error_check ccall((:at_load, :libdoeye_caml), Cint, (Cstring, Ptr{Cvoid}), filename, op)
end

function at_save_multi(tensors, tensor_names, ntensors, filename)
    @runtime_error_check ccall((:at_save_multi, :libdoeye_caml), Cint, (Ptr{tensor}, Ptr{Cstring}, Cint, Cstring), tensors, tensor_names, ntensors, filename)
end

function at_load_multi(tensors, tensor_names, ntensors, filename)
    @runtime_error_check ccall((:at_load_multi, :libdoeye_caml), Cint, (Ptr{tensor}, Ptr{Cstring}, Cint, Cstring), tensors, tensor_names, ntensors, filename)
end

function at_load_multi_(tensors, tensor_names, ntensors, filename)
    @runtime_error_check ccall((:at_load_multi_, :libdoeye_caml), Cint, (Ptr{tensor}, Ptr{Cstring}, Cint, Cstring), tensors, tensor_names, ntensors, filename)
end

function at_load_callback(filename, f)
    @runtime_error_check ccall((:at_load_callback, :libdoeye_caml), Cint, (Cstring, Ptr{Cvoid}), filename, f)
end
...
function ato_adam(op, learning_rate, beta1, beta2, weight_decay)
    @runtime_error_check ccall((:ato_adam, :libdoeye_caml), Cint, (optimizer, Cdouble, Cdouble, Cdouble, Cdouble), op, learning_rate, beta1, beta2, weight_decay)
end

function ato_rmsprop(op, learning_rate, alpha, eps, weight_decay, momentum, centered)
    @runtime_error_check ccall((:ato_rmsprop, :libdoeye_caml), Cint, (optimizer, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cint), op, learning_rate, alpha, eps, weight_decay, momentum, centered)
end

function ato_sgd(op, learning_rate, momentum, dampening, weight_decay, nesterov)
    @runtime_error_check ccall((:ato_sgd, :libdoeye_caml), Cint, (optimizer, Cdouble, Cdouble, Cdouble, Cdouble, Cint), op, learning_rate, momentum, dampening, weight_decay, nesterov)
end
...
function ats_int(op, arg1)
    @runtime_error_check ccall((:ats_int, :libdoeye_caml), Cint, (scalar, Int64,), op, arg1)
end

function ats_float(op, arg1)
    @runtime_error_check ccall((:ats_float, :libdoeye_caml), Cint, (scalar, Cdouble,), op, arg1)
end
...
function atc_cuda_device_count()
    op = Int32[-1]
    @runtime_error_check ccall((:atc_cuda_device_count, :libdoeye_caml), Cint, (Ptr{Cint}, ), op)
    op[]
end

function atc_cuda_is_available()
    op = Int32[-1]
    @runtime_error_check ccall((:atc_cuda_is_available, :libdoeye_caml), Cint, (Ptr{Cint}, ), op)
    op[]
end

function atc_cudnn_is_available()
    op = Int32[-1]
    @runtime_error_check ccall((:atc_cudnn_is_available, :libdoeye_caml), Cint, (Ptr{Cint}, ), op)
    op[]
end
...
function atm_load(arg1, op)
    @runtime_error_check ccall((:atm_load, :libdoeye_caml), Cint, (Cstring, Ptr{module_t}), arg1, op)
end

function atm_forward(op, arg1, tensors, ntensors)
    @runtime_error_check ccall((:atm_forward, :libdoeye_caml), Cint, (Ptr{tensor}, module_t, Ptr{tensor}, Cint), op, arg1, tensors, ntensors)
end

function atm_forward_(op, arg1, ivalues, nivalues)
    @runtime_error_check ccall((:atm_forward_, :libdoeye_caml), Cint, (Ptr{ivalue}, module_t, Ptr{ivalue}, Cint), op, arg1, ivalues, nivalues)
end

function atm_free(arg1)
    @runtime_error_check ccall((:atm_free, :libdoeye_caml), Cint, (module_t,), arg1)
end

function ati_tensor(op, arg1)
    @runtime_error_check ccall((:ati_tensor, :libdoeye_caml), Cint, (Ptr{ivalue}, tensor,), op, arg1)
end

function ati_int(op, arg1)
    @runtime_error_check ccall((:ati_int, :libdoeye_caml), Cint, (Ptr{ivalue}, Int64,), op, arg1)
end

function ati_double(op, arg1)
    @runtime_error_check ccall((:ati_double, :libdoeye_caml), Cint, (Ptr{ivalue}, Cdouble,), op, arg1)
end

function ati_tuple(op, arg1, arg2)
    @runtime_error_check ccall((:ati_tuple, :libdoeye_caml), Cint, (Ptr{ivalue}, Ptr{ivalue}, Cint), op, arg1, arg2)
end

function ati_to_tensor(op, arg1)
    @runtime_error_check ccall((:ati_to_tensor, :libdoeye_caml), Cint, (Ptr{tensor}, ivalue,), op, arg1)
end

function ati_to_int(op, arg1)
    @runtime_error_check ccall((:ati_to_int, :libdoeye_caml), Cint, (Ptr{Int64}, ivalue,), op, arg1)
end

function ati_to_double(op, arg1)
    @runtime_error_check ccall((:ati_to_double, :libdoeye_caml), Cint, (Ptr{Cdouble}, ivalue,), op, arg1)
end

function ati_tuple_length(op, arg1)
    @runtime_error_check ccall((:ati_tuple_length, :libdoeye_caml), Cint, (Ptr{Cint}, ivalue,), op, arg1)
end
...
function ati_tag(arg1)
    @runtime_error_check ccall((:ati_tag, :libdoeye_caml), Cint, (Ptr{Cint}, ivalue,), op, arg1)
end
...
function atg_align_tensors(op::AbstractVector, tensors_data, tensors_len)
    @runtime_error_check ccall((:atg_align_tensors, :libdoeye_caml), Cint, (Ptr{Ptr{Cvoid}}, Ptr{tensor}, Cint), op, tensors_data, tensors_len)
end
...
function atg_broadcast_tensors(op::AbstractVector, tensors_data, tensors_len)
    @runtime_error_check ccall((:atg_broadcast_tensors, :libdoeye_caml), Cint, (Ptr{Ptr{Cvoid}}, Ptr{tensor}, Cint), op, tensors_data, tensors_len)
end
...
function atg_cdist(arg1, x1, x2, p)
    @runtime_error_check ccall((:atg_cdist, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, Cdouble), arg1, x1, x2, p)
end
...
function atg_cudnn_batch_norm_backward(arg1, input, grad_output, weight, running_mean, running_var, save_mean, save_var, epsilon)
    @runtime_error_check ccall((:atg_cudnn_batch_norm_backward, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, tensor, tensor, tensor, tensor, tensor, Cdouble), arg1, input, grad_output, weight, running_mean, running_var, save_mean, save_var, epsilon)
end
...
function atg_cumprod(arg1, self, dim, dtype_t)
    @runtime_error_check ccall((:atg_cumprod, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Int64, Cint), arg1, self, dim, dtype_t)
end

function atg_cumprod_out(arg1, out, self, dim, dtype_t)
    @runtime_error_check ccall((:atg_cumprod_out, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, Int64, Cint), arg1, out, self, dim, dtype_t)
end

function atg_cumsum(arg1, self, dim, dtype_t)
    @runtime_error_check ccall((:atg_cumsum, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Int64, Cint), arg1, self, dim, dtype_t)
end

function atg_cumsum_out(arg1, out, self, dim, dtype_t)
    @runtime_error_check ccall((:atg_cumsum_out, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, Int64, Cint), arg1, out, self, dim, dtype_t)
end
...
function atg_dot(arg1, self, tensor_t)
    @runtime_error_check ccall((:atg_dot, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor), arg1, self, tensor_t)
end

function atg_dot_out(arg1, out, self, tensor_t)
    @runtime_error_check ccall((:atg_dot_out, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, tensor), arg1, out, self, tensor_t)
end
...
function atg_embedding_renorm_(arg1, self, indices, max_norm, norm_type_t)
    @runtime_error_check ccall((:atg_embedding_renorm_, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, Cdouble, Cdouble), arg1, self, indices, max_norm, norm_type_t)
end
...
function atg_log_softmax(arg1, self, dim, dtype_t)
    @runtime_error_check ccall((:atg_log_softmax, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Int64, Cint), arg1, self, dim, dtype_t)
end
...
function atg_mean(arg1, self, dtype_t)
    @runtime_error_check ccall((:atg_mean, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Cint), arg1, self, dtype_t)
end

function atg_mean1(arg1, self, dim_data, dim_len, keepdim, dtype_t)
    @runtime_error_check ccall((:atg_mean1, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Ptr{Int64}, Cint, Cint, Cint), arg1, self, dim_data, dim_len, keepdim, dtype_t)
end

function atg_mean_out(arg1, out, self, dim_data, dim_len, keepdim, dtype_t)
    @runtime_error_check ccall((:atg_mean_out, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, Ptr{Int64}, Cint, Cint, Cint), arg1, out, self, dim_data, dim_len, keepdim, dtype_t)
end
...
function atg_meshgrid(op::AbstractVector, tensors_data, tensors_len)
    @runtime_error_check ccall((:atg_meshgrid, :libdoeye_caml), Cint, (Ptr{Ptr{Cvoid}}, Ptr{tensor}, Cint), op, tensors_data, tensors_len)
end
...
function atg_nonzero_numpy(op::AbstractVector, self)
    @runtime_error_check ccall((:atg_nonzero_numpy, :libdoeye_caml), Cint, (Ptr{tensor}, tensor,), op, self)
end
...
function atg_norm1(arg1, self, p, dtype_t)
    @runtime_error_check ccall((:atg_norm1, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, scalar, Cint), arg1, self, p, dtype_t)
end
...
function atg_norm3(arg1, self, p, dim_data, dim_len, keepdim, dtype_t)
    @runtime_error_check ccall((:atg_norm3, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, scalar, Ptr{Int64}, Cint, Cint, Cint), arg1, self, p, dim_data, dim_len, keepdim, dtype_t)
end
...
function atg_norm_out1(arg1, out, self, p, dim_data, dim_len, keepdim, dtype_t)
    @runtime_error_check ccall((:atg_norm_out1, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, scalar, Ptr{Int64}, Cint, Cint, Cint), arg1, out, self, p, dim_data, dim_len, keepdim, dtype_t)
end
...
function atg_prod(arg1, self, dtype_t)
    @runtime_error_check ccall((:atg_prod, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Cint), arg1, self, dtype_t)
end

function atg_prod1(arg1, self, dim, keepdim, dtype_t)
    @runtime_error_check ccall((:atg_prod1, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Int64, Cint, Cint), arg1, self, dim, keepdim, dtype_t)
end

function atg_prod_out(arg1, out, self, dim, keepdim, dtype_t)
    @runtime_error_check ccall((:atg_prod_out, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, Int64, Cint, Cint), arg1, out, self, dim, keepdim, dtype_t)
end
...
function atg_quantize_per_channel(arg1, self, scales, zero_points, axis, dtype_t)
    @runtime_error_check ccall((:atg_quantize_per_channel, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, tensor, Int64, Cint), arg1, self, scales, zero_points, axis, dtype_t)
end

function atg_quantize_per_tensor(arg1, self, scale, zero_point, dtype_t)
    @runtime_error_check ccall((:atg_quantize_per_tensor, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Cdouble, Int64, Cint), arg1, self, scale, zero_point, dtype_t)
end
...
function atg_softmax(arg1, self, dim, dtype_t)
    @runtime_error_check ccall((:atg_softmax, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Int64, Cint), arg1, self, dim, dtype_t)
end
...
function atg_split(op::AbstractVector, self, split_size, dim)
    @runtime_error_check ccall((:atg_split, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Int64, Int64), op, self, split_size, dim)
end

function atg_split_with_sizes(op::AbstractVector, self, split_sizes_data, split_sizes_len, dim)
    @runtime_error_check ccall((:atg_split_with_sizes, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Ptr{Int64}, Cint, Int64), op, self, split_sizes_data, split_sizes_len, dim)
end
...
function atg_sum(arg1, self, dtype_t)
    @runtime_error_check ccall((:atg_sum, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Cint), arg1, self, dtype_t)
end

function atg_sum1(arg1, self, dim_data, dim_len, keepdim, dtype_t)
    @runtime_error_check ccall((:atg_sum1, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Ptr{Int64}, Cint, Cint, Cint), arg1, self, dim_data, dim_len, keepdim, dtype_t)
end

function atg_sum_out(arg1, out, self, dim_data, dim_len, keepdim, dtype_t)
    @runtime_error_check ccall((:atg_sum_out, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, tensor, Ptr{Int64}, Cint, Cint, Cint), arg1, out, self, dim_data, dim_len, keepdim, dtype_t)
end
...
function atg_totype(arg1, self, scalar_type_t)
    @runtime_error_check ccall((:atg_totype, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Cint), arg1, self, scalar_type_t)
end
...
function atg_unbind(op::AbstractVector, self, dim)
    @runtime_error_check ccall((:atg_unbind, :libdoeye_caml), Cint, (Ptr{tensor}, tensor, Int64), op, self, dim)
end
...
function atg_where(op::AbstractVector, condition)
    @runtime_error_check ccall((:atg_where, :libdoeye_caml), Cint, (Ptr{tensor}, tensor,), op, condition)
end
