...
void atg_align_tensors(tensor *, tensor *tensors_data, int tensors_len);
...
void atg_broadcast_tensors(tensor *, tensor *tensors_data, int tensors_len);
...
void atg_chunk(tensor *, tensor self, int64_t chunks, int64_t dim);
...
void atg_meshgrid(tensor *, tensor *tensors_data, int tensors_len);
...
void atg_nonzero_numpy(tensor *, tensor self);
...
void atg_split(tensor *, tensor self, int64_t split_size, int64_t dim);
// tensor *atg_split_with_sizes(tensor self, int64_t *split_sizes_data, int split_sizes_len, int64_t dim);
void atg_split_with_sizes(tensor *, tensor self, int64_t *split_sizes_data, int split_sizes_len, int64_t dim);
...
void atg_unbind(tensor *, tensor self, int64_t dim);
...
void atg_where(tensor *, tensor condition);
